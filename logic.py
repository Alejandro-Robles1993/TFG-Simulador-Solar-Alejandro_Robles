def calcular_presupuesto_solar(consumo_anual_kwh, precio_kwh, horas_sol_media, precio_instalacion):
    ...
    kw_necesarios = consumo_anual_kwh / horas_sol_media
    ...
    # Cálculo del impacto económico directo sobre el consumo actual
    ahorro_anual = consumo_anual_kwh * precio_kwh
    ...
    return {
        ...
        "tiempo_amortizacion": round(tiempo_amortizacion, 2)
    }